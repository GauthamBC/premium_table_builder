...
def generate_html(df, cfg):
    ...
    header_logo = f'<img class="header-logo" src="{html.escape(logo)}" alt="{html.escape(cfg["brand"])} logo">' if cfg["header_logo"] else ""
