...
with right:
    with st.container(border=True):
        ...
        st.caption(f"{len(df):,} rows · {len(columns)} columns · {brand}. The live preview stays pinned beside the builder while you scroll. The header stays clean, and wide tables use subtle edge hints plus the branded horizontal scrollers.")
