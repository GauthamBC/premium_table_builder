...
def generate_html(df, cfg):
    ...
    if cfg["brand"] == "BOLAVIP":
        header_logo_max_w = 132
        header_logo_max_h = 34
        footer_logo_max_w = 126
        footer_logo_max_h = 30
        mobile_header_logo_max_w = 112
        mobile_header_logo_max_h = 29
    else:
        header_logo_max_w = 190
        header_logo_max_h = 48
        footer_logo_max_w = 180
        footer_logo_max_h = 38
        mobile_header_logo_max_w = 145
        mobile_header_logo_max_h = 36
